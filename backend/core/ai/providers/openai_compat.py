    ...
    def chat(
        ...
        *,
        ...
        if not self.api_key and "127.0.0.1" not in (self.base_url or "") and "localhost" not in (
            ...
            # Still allow empty key for local endpoints.
            pass
        ...
        # Drop empty Authorization for local servers
        if not self.api_key:
        ...
        return LlmTurn(content=content, tool_calls=[], usage=usage, raw=data)
...
def _extract_content(data: dict[str, Any]) -> str:
    ...
    # Some proxies return text field
